...
<li>
    Extended User Roles and Permissions: To enhance system security, IreneAPI plans to integrate custom user roles with permissions tailored for different levels of access (e.g., Admin, Merchant, Customer).
</li>
</ol>
